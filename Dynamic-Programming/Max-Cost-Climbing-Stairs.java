public  int minCostClimbingStairs(int[] cost) {
        ...
        //minimum of both
        return Math.max(indexOne, indexZero);
     }
    ...
    public  int findClimbs(int currIndex, int[] cost, HashMap<Integer, Integer> memo) {
        ...
        //when you hav over jumped the last stair, return 0
        else if (currIndex > cost.length) return 0;
        ...
        //update the map
        memo.put(currIndex, Math.max(oneJump, twoJumps));
